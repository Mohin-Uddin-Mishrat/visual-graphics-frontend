    ...
    <main className="min-h-full bg-[#f1f3f7] px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        <div className="space-y-2">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-violet-600">Admin Upload</p>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">Upload Client Asset</h1>
          <p className="max-w-2xl text-sm text-slate-600 sm:text-base">
            Send files into the admin asset pipeline with <code>isClientSent=false</code>.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          >
            <div className="mx-auto flex max-w-2xl flex-col items-center gap-6">
              ...
              <p className="text-sm text-slate-500">
                ZIP files and images are accepted. The upload will be marked as admin-originated automatically.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-slate-600">
              {copiedUrl ? copiedUrl : file ? 'Selected file is ready for admin upload.' : 'Choose one file to begin.'}
            </div>
            {copiedUrl ? (
              <button
                type="button"
